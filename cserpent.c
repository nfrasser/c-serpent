...
usage(void)
{
	...
	"          wrappers.c mylib.c -o mymodule.so \n"
	"                                                                             \n"
	...
	"      errarg = N       argument handed to errcheck, 1-based; 0, the      \n"
	"                       default, means the return value. Unlike errbuf,  \n"
	"                       this argument stays in the python signature.     \n"
	...
	"    Generate a type-dispatching wrapper over the suffixed variants of the  \n"
	"    prefix, plus a wrapper for each variant found. Takes all              \n"
	"    CSERPENT_WRAPFN options, plus strip_underscore = 0|1                  \n"
	"    (default 1: sum_ dispatches as 'sum'). \n"
	"                                                                             \n"
	...
	"    Register hand-written wrappers. c-serpent adds each function named to  \n"
	"    the module and expects you to supply a 'wrap_<fn_name>' for each.      \n"
	"    Accepts the doc and name options from CSERPENT_WRAPFN.                 \n"
	"                                                                             \n"
	...
	"    or a typedef name. Scalar members are the only ones you can assign    \n"
	"    to. Nested structs and fixed-size arrays are still mutable, because   \n"
	"    reading one gives a view onto the struct's own memory rather than a   \n"
	"    copy: obj.inner.x = 5 and obj.arr[:] = ... write through, while       \n"
	"    obj.inner = ... is an error. Pointer members are read-only.           \n"
